...
def db_task_add_user_file(task_name, user_id):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_FILES_USERS
    res = BotWoody.r.sadd(key_name, user_id)
    return res


def db_task_del_user_file(task_name, user_id):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_FILES_USERS
    res = BotWoody.r.srem(key_name, user_id)
    return res


def db_task_get_users_file(task_name):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_FILES_USERS
    res = [bytes.decode(x) for x in BotWoody.r.smembers(key_name)]
    return res


def db_task_add_user_msg(task_name, user_id):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_MSG_USERS
    res = BotWoody.r.sadd(key_name, user_id)
    return res


def db_task_del_user_msg(task_name, user_id):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_MSG_USERS
    res = BotWoody.r.srem(key_name, user_id)
    return res


def db_task_get_users_msg(task_name):
    key_name = R_PREFIX_PRIMARY + R_PREFIX_TASK + task_name + R_PREFIX_MSG_USERS
    res = [bytes.decode(x) for x in BotWoody.r.smembers(key_name)]
    return res
